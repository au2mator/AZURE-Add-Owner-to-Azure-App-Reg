...
$ChannelName = "General"
###TeamsCredentials to send Teams Card #https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=Azure_AddOwnerAzureAppReg&utm_content=PS1
...
###Stored Credentials
###See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=Azure_AddOwnerAzureAppReg&utm_content=PS1
